...
<Figure
  ...
  id="result"
>
  The resultant image from the hologram was generated using the code in the
  article below.
</Figure>
...
If you make one at home [show me](//github.com/rjkilpatrick/kilpatrick.co.uk/issues/new)!
