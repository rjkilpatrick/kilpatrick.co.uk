...
**tl;dr:** Give it a go [here](//github.com/rjkilpatrick/virtual-window).
...
>
  ...
  [here](//github.com/rjkilpatrick/virtual-window).
</Figure>
...
It also makes sense, now I am using astro for [this site](./2022-12-30-kilpatrick.co.uk), so that I can use the JS packages so that I'm not hotlinking to [CDNs](https://www.cloudflare.com/en-gb/learning/cdn/what-is-a-cdn/) for my dependencies.
